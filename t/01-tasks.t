...
my @addinfo = capture([0..5],"pairfq -t addinfo 2>&1");
my @makepairs = capture([0..5],"pairfq -t makepairs 2>&1");
my @splitpairs = capture([0..5],"pairfq -t splitpairs 2>&1");
my @joinpairs = capture([0..5],"pairfq -t joinpairs 2>&1");
my @wrongtask = capture([0..5],"pairfq -t jonpairs 2>&1");
