...
my @addinfo = capture([0..5],"pairfq addinfo 2>&1");
my @makepairs = capture([0..5],"pairfq makepairs 2>&1");
my @splitpairs = capture([0..5],"pairfq splitpairs 2>&1");
my @joinpairs = capture([0..5],"pairfq joinpairs 2>&1");
my @wrongtask = capture([0..5],"pairfq jonpairs 2>&1");
